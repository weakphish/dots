...
Before starting a coding task, identify the start and stop point and ask me to approve it using the `question` tool from `@agent/extensions/question.ts`.

For a research or answering-type task, repeat back to me your understanding of the question and your plan for answering 
it. Use the `question` tool for this as well. 
