...
nmap_leader('nD', '<Cmd>Obsidian dailies<CR>', 'View daily notes')
nmap_leader('nf', '<Cmd>Obsidian quick_switch<CR>', 'Find note')
nmap_leader('ns', '<Cmd>Obsidian search<CR>', 'Search notes')
...
nmap_leader('nt', '<Cmd>Obsidian tags<CR>', 'View tags')
...
nmap_leader('os', '<Cmd>lua require("grug-far").open({ prefills = { search = vim.fn.expand("<cword>") } })<CR>',
  'Search and replace')
